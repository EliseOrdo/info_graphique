...
int main()
{
    ...
    Texture *texturevitraille = new Texture("/Users/eliseordoquy/Programmation/OpenGL/info_graphique/textures/vitraille.png");
    ...
    glm::mat4 carre1_mat = glm::translate(glm::mat4(1.0f), glm::vec3(-20.0f, -2.0f, 0.0f))
        * glm::scale(glm::mat4(1.0f), glm::vec3(1.0f, 1.0f, 1.0f))
